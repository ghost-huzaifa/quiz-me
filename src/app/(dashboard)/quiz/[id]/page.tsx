...
export default async function QuizInstructionsPage({ params }: QuizInstructionsPageProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-on-background/40 backdrop-blur-sm overflow-y-auto">
      {/* Centering Wrapper */}
      <div className="flex min-h-full items-start md:items-center justify-center p-margin-mobile md:p-margin-desktop">
        {/* Modal Content Container */}
        <div className="glass-panel w-full max-w-2xl rounded-xl shadow-level-2 overflow-hidden bg-surface-bright border border-outline-variant/30 my-4 md:my-8">
